...
#define macEV (ev.isDisabled()||!macDebug) ? EV : EV << "[802154_MACAttacker]: "    // switchable debug output
...
class IEEE802154MacAttacker : public cSimpleModule, public INotifiable
{
