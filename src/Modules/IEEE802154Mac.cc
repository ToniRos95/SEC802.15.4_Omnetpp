...
std::string IEEE802154Mac::AEADDecypher64(std::string cipher, std::string radata)
{
...
std::string IEEE802154Mac::AEADDecypher128(std::string cipher, std::string radata)
{
...
std::string IEEE802154Mac::CBCMACAuth64(std::string plain)
{
...
std::string IEEE802154Mac::CBCMACAuth128(std::string plain)
{
...
void IEEE802154Mac::setAPDATA(std::string *adata, std::string *pdata, mpdu *frame, bool encryption)
{
