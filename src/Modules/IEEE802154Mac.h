...
class IEEE802154Mac : public cSimpleModule, public INotifiable
{
    ...
    protected:
        ...
        std::string CBCMACVerify32(std::string plain, std::string mac);
        std::string CBCMACVerify64(std::string plain, std::string mac);
        std::string CBCMACVerify128(std::string plain, std::string mac);
        ...
        std::string secRecAck(AckFrame* ack, int secuLevel);
